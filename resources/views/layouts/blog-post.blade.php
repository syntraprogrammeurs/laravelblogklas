        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="logo-area">
                        <a href="index.html"><img src="{{asset('images/core-img/logo.png')}}" alt="logo"></a>
                    </div>
                </div>
                <!-- Header Advert Area -->
                <div class="col-12 col-md-8">
                    <div class="header-advert-area">
                        <a href="#"><img src="{{asset('images/bg-img/top-advert.png')}}" alt="header-add"></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Footer Area Start -->
<footer class="footer-area bg-img background-overlay" style="background-image: url({{asset('images/bg-img/4.jpg')}});">
    <!-- Top Footer Area -->
